...
urlpatterns = [
    ...
    path('get_env_address/', views.get_https_address_env), 
	...
	path('tournament/<str:tournament_code>/tournament_players/', views.get_tournament_players, name='get_tournament_players'),
