...
//         if (response.ok) {
//             [1, 2, 3].forEach(num => {
//                 const token = document.getElementById(`token${num}`).querySelector('.token');
//                 token.classList.add('flipped');
//                 // const token = document.getElementById(`token${num}`);
//                 token.animate([
//                     { transform: 'rotateY(0deg)' },
//                     { transform: 'rotateY(180deg)' }
//                 ], {
//                     duration: 1000,
//                 });
//                 // const tokenfront = document.getElementById(`imgtoken${num}`);
//                 // token.style.transform = 'rotateY(180deg)';
//                 // tokenfront.style.display = 'none';
//             });
//         }
//     } catch (error) {
//         console.error('Error: ' + error);
