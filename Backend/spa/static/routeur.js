...
const routes = {
    '/': () => fetch('/static/pages/home.html').then(response => response.text()),
    '/profile': () => fetch('/static/pages/profile.html').then(response => response.text()),
    '/game': () => fetch('/static/pages/game.html').then(response => response.text()),
